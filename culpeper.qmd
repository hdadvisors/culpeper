...
| Attribute | Major | Minor | 10 Acre | Family |
|-------------------|----------------|----------------|-------------------|-----------------|
| 1. Eligibility Criteria | No specific restrictions; applies when other division types are not applicable | Any existing parcel | Only in A-1 (Agricultural) or RA (Rural Residential) districts | In A-1, RA, RR, R-1, or R-2 districts; property owned for at least 5 years |
| 2. Number of Lots Created | No specific limit | Up to 3 new lots plus remnant within a 5-year period | No specific limit mentioned | Single division per family member |
| 3. Minimum Lot Size | As per zoning district requirements | As per zoning district requirements | 10 acres for each lot, including remnant | Minimum of zoning district or 1 acre, whichever is less |
| 4. Road Access Requirements | As per VDOT standards | Existing street access | 50-foot wide easement to public street | 20-foot wide easement to public street |
| 5. Review and Approval Process | Full preliminary and final plat review | Simplified review process | Simplified review process | Simplified review process |
| 6. Development Standards | Full compliance with all subdivision standards | May be exempted from some standard procedures | May be exempted from some standard procedures | May be exempted from some standard procedures |
| 7. Time Restrictions | None specified | No more than once every 5 years | None specified | Grantee cannot transfer for 5 years |
| 8. Special Conditions or Restrictions | None specific to this type | Must not adversely affect remainder of parcel or adjoining property | Requires perpetual maintenance agreement for private roads | Only for immediate family members; affidavit required |
| 9. Intended Purpose/Use | Large-scale residential development | Small-scale divisions of land | Large-lot rural development | Allowing property owners to give/sell land to family members |
